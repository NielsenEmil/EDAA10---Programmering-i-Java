...
public class LifeView extends Frame {
	...
	/**
	 * Ritar upp de fixa delarna av spelplanen (rutnŠtet, generationsrŠknaren och
	 * knapparna)
	 */
	...
	/**
	 * VŠntar tills anvŠndaren klickar med musen. Ger: 1: Klick i ruta på
	 * spelplanen. Index fšr rutan kan hŠmtas med getRow och getCol 2: Klick i
